...
from LocalAutoaugment import LocalizedAutoAugment
...
transform_train_list = [
        ...
        # transforms.Lambda(lambda img: ImageNetPolicy()(img)),
        # LocalizedAutoAugment(ImageNetPolicy(), n=4, m=4, k=5),
        # LocalizedAutoAugment(ImageNetPolicy(), n=4, m=4, k=5, save_dir="./localAug2/"),
        LocalizedAutoAugment(ImageNetPolicy(), n=4, m=4, k=5, save_dir="./localAug3/", probability=0.5, whole_image_probability=0.2),
